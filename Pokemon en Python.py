...
if __name__ == '__main__':
	...
	if opc==1:
		...
		print(" |                                              |")
		print(" |  �Bienvenidos al  mundo de POK�MON!          |")
		print(" |                                         \/   |")
		print(" @----------------------------------------------@")
		input() # a diferencia del pseudoc�digo, espera un Enter, no cualquier tecla
		print("") # no hay forma directa de borrar la pantalla con Python estandar
		...
		print(" |  �Me llamo AOK!                              |")
		print(" |                                              |")
		print(" |  �Pero la gente me llama el PROFESOR POK�Mon!|")
		print(" |                                         \\/   |")
		print(" @----------------------------------------------@")
		input() # a diferencia del pseudoc�digo, espera un Enter, no cualquier tecla
		print("") # no hay forma directa de borrar la pantalla con Python estandar
		...
		print(" @----------------------------------------------@")
		print(" |                                              |")
		print(" |  �Este mundo est� habitado por unas          |")
		print(" |                                              |")
		print(" |  criaturas llamadas POK�Mon!                 |")
		print(" |                                         \\/   |")
		print(" @----------------------------------------------@")
		input() # a diferencia del pseudoc�digo, espera un Enter, no cualquier tecla
		print("") # no hay forma directa de borrar la pantalla con Python estandar
		...
		print(" @----------------------------------------------@")
		print(" |                                              |")
		print(" |  Para algunos, los POK�MON son mascotas.     |")
		print(" |                                              |")
		...
		print(" @----------------------------------------------@")
		print(" |                                              |")
		print(" |  Estudio a los POK�MON como profesi�n.       |")
		print(" |                                              |")
		print(" |                                              |")
		print(" |                                         \\/   |")
		print(" @----------------------------------------------@")
		...
		print(" @----------------------------------------------@")
		print(" |                                              |")
		print(" |  Pero primero dime c�mo te llamas.           |")
		print(" |                                              |")
		print(" |                                              |")
		print(" |                                         \\/   |")
		print(" @----------------------------------------------@")
		...
		print(" @----------------------------------------------@")
		print(" |                                              |")
		print(" |  Este es mi nieto. �l ha sido tu rival desde |")
		print(" |                                              |")
		print(" |  que eras un ni�o.                           |")
		print(" |                                         \\/   |")
		print(" @----------------------------------------------@")
		while True:# no hay 'repetir' en python
			input() # a diferencia del pseudoc�digo, espera un Enter, no cualquier tecla
			...
			print(" @----------------------------------------------@")
			print(" |                                              |")
			print(" |  ...Mmm, �podr�as decirme c�mo se llama?     |")
			print(" |                                              |")
			print(" |                                              |")
			print(" |                                         \\/   |")
			print(" @----------------------------------------------@")
		...
		print(" @----------------------------------------------@")
		print(" |                                              |")
		print(" |  �",jugador1,"!   �Tu propia leyenda POK�MON |")
		print(" |                                              |")
		print(" |  est� a punto de comenzar!                   |")
		print(" |                                         \\/   |")
		print(" @----------------------------------------------@")
		input() # a diferencia del pseudoc�digo, espera un Enter, no cualquier tecla
		print("") # no hay forma directa de borrar la pantalla con Python estandar
		...
		print(" @----------------------------------------------@")
		print(" |                                              |")
		print(" |  �Te espera un mundo de sue�os y aventuras   |")
		print(" |                                              |")
		print(" |  con los POK�MON!                            |")
		print(" |                                         \\/   |")
		print(" @----------------------------------------------@")
		input() # a diferencia del pseudoc�digo, espera un Enter, no cualquier tecla
		while True:# no hay 'repetir' en python
		...
		if opc3==4:
			...
			sleep(1)
			print(" |    �En la hierba viven POK�MON salvajes!     |")
			print(" |                                              |")
			print(" |                                              |")
			print(" @----------------------------------------------@")
			sleep(3)
			...
			print(" | OAK: Vaya...                                 |")
			sleep(1)
			print(" |  �Necesitas a tu propio POK�MON como         |")
			print(" |                         protecci�n           |")
			print(" |                                         \\/   |")
			print(" @----------------------------------------------@")
			input() # a diferencia del pseudoc�digo, espera un Enter, no cualquier tecla
			...
			print(" |                                              |")
			sleep(2)
			print(" | OAK: �Hum? �Qu� haces aqu� ya?               |")
			sleep(1)
			print(" |  Te dije que vinieras m�s  tarde...          |")
			sleep(1)
			print(" |  �No importa!    Espera ah�.                 |")
			print(" |                                         \\/   |")
			print(" @----------------------------------------------@")
			input() # a diferencia del pseudoc�digo, espera un Enter, no cualquier tecla
			print("") # no hay forma directa de borrar la pantalla con Python estandar
			...
			sleep(1)
			print(" |  est� en la mesa? Se llama POK�BALL.                           |")
			sleep(1)
			print(" |  Contiene un POK�MON en su interior.         |")
			print(" |                                         \\/   |")
			print(" @----------------------------------------------@")
			input() # a diferencia del pseudoc�digo, espera un Enter, no cualquier tecla
			print("") # no hay forma directa de borrar la pantalla con Python estandar
			...
			if opc4==0:
				...
				print(" |                                              |")
				print(" |  POK�MON!                                    |")
				print(" |           ",enemigo1," !Ha cogido el POK�MON!|")
				print(" @----------------------------------------------@")
				input() # a diferencia del pseudoc�digo, espera un Enter, no cualquier tecla
				print("") # no hay forma directa de borrar la pantalla con Python estandar
				print("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")
				...
				print(" | ",enemigo1," �Abuelo, yo quiero �ste!        |")
				sleep(1)
				print(" | OAK: Pero... Bueno. Vale.                    |")
				print(" |           Ese POK�MON es tuyo.               |")
				print(" @----------------------------------------------@")
				input() # a diferencia del pseudoc�digo, espera un Enter, no cualquier tecla
				print("") # no hay forma directa de borrar la pantalla con Python estandar
				print("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")
				...
				print(" @----------------------------------------------@")
				print(" |                                              |")
				print(" | OAK: ",jugador1,", �ste es el POK�MON que  |")
				print(" |  atrap� antes. Puedes tenerlo.               |")
				print(" |  Lo cog� en estado salvaje, asi que no es    |")
				print(" |  manso todav�a.                              |")
				print(" @----------------------------------------------@")
				input() # a diferencia del pseudoc�digo, espera un Enter, no cualquier tecla
	if opc!=2:
	...
	if opc==1 or opc==4:
		while salir==False:
			while True:# no hay 'repetir' en python
				...
				print(" |  3.- LABORATORIO DE INVESTIGACI�N  de POK�MON|")
			...
			if opc3==2:
				if mipoke[0]!="":
					while True:# no hay 'repetir' en python
						...
						print("XXXXXXXXXX|                           |XXXXXXXXXX")
						print("XXXXXXXXXX|                           |XXXXXXXXXX")
						print("XXXXXXXXXX|   2.- Duelo 6 POK�MON     |XXXXXXXXXX")
						print("XXXXXXXXXX|                           |XXXXXXXXXX")
						print("XXXXXXXXXX@---------------------------@XXXXXXXXXX")
					...
					if cantidadpoke==1:
						if totalsalud==0:
							print("Ve de inmediato a curar a tu Pok�mon")
							input() # a diferencia del pseudoc�digo, espera un Enter, no cualquier tecla
						if enetotalsalud==0 and totalsalud>0:
							print("El Pok�mon de ",enemigo1," est� debilidato. ")
							print("Ve a Curar a tu Pikachu y curaras al EEVEE de ",enemigo1)
							input() # a diferencia del pseudoc�digo, espera un Enter, no cualquier tecla
					if cantidadpoke==6:
						if totalsalud==0:
							print("Ve de inmediato a curar a tus Pok�mon")
							input() # a diferencia del pseudoc�digo, espera un Enter, no cualquier tecla
						if enetotalsalud==0 and totalsalud>0:
							print("Los Pok�mon de ",enemigo1," estan debilidatos")
							print("Ve a Curar los tuyos y curaras lo de el tambien")
							input() # a diferencia del pseudoc�digo, espera un Enter, no cualquier tecla
						if enetotalsalud>0 and totalsalud==0:
							print("�",jugador1,"Tus Pok�mon estan debilidatos!")
					...
					while (opc6==1 or opc6==2) and (totalsalud>0 and enetotalsalud>0):
						...
						if opc6==1 and cantidadpoke==6:
							while True:# no hay 'repetir' en python
								...
								print("")
								print("")
								print("                                                  Opci�n 0 VOLVER")
								opcmipoke = int(input())
								start = True
								if opcmipoke==1 and mipokeh1[0]==0:
									print("Pok�mon ",mipoke[0]," debilitado, ve al laboratorio para Curarlo")
									input() # a diferencia del pseudoc�digo, espera un Enter, no cualquier tecla
								if opcmipoke==2 and mipokeh2[0]==0:
									print("Pok�mon ",mipoke[1]," debilitado, ve al laboratorio para Curarlo")
									input() # a diferencia del pseudoc�digo, espera un Enter, no cualquier tecla
								if opcmipoke==3 and mipokeh3[0]==0:
									print("Pok�mon ",mipoke[2]," debilitado, ve al laboratorio para Curarlo")
									input() # a diferencia del pseudoc�digo, espera un Enter, no cualquier tecla
								if opcmipoke==4 and mipokeh4[0]==0:
									print("Pok�mon ",mipoke[3]," debilitado, ve al laboratorio para Curarlo")
									input() # a diferencia del pseudoc�digo, espera un Enter, no cualquier tecla
								if opcmipoke==5 and mipokeh5[0]==0:
									print("Pok�mon ",mipoke[4]," debilitado, ve al laboratorio para Curarlo")
									input() # a diferencia del pseudoc�digo, espera un Enter, no cualquier tecla
								if opcmipoke==6 and mipokeh6[0]==0:
									print("Pok�mon ",mipoke[5]," debilitado, ve al laboratorio para Curarlo")
									input() # a diferencia del pseudoc�digo, espera un Enter, no cualquier tecla
						...
						if opc6==2:
							if cantidadpoke==6 and micontwin<=5 and enecontwin<=5:
								...
								if cantidadpoke==1:
									print(jugador1," tienes que tener 6 Pok�mon para poder jugar")
									sleep(2)
								if cantidadpoke==6:
						...
						if start==True:
							...
							if opcmipoke!=0:
								...
								if enesaludpoke<=0:
									...
									print("Pok�mon enemigo bajo de vida")
									sleep(2)
								else:
								...
								if misaludpoke<=0:
									...
									print("Pok�mon Bajo de vida ",jugador1)
									sleep(2)
								else:
								...
								if mihp==True and enehp==True:
									...
									print("                             |-----------------")
									print("�------------------------------------------------�")
									print("|   ",enemigo1," Envi� a ",enenombrepoke)
									print("|   ")
									print("�------------------------------------------------�")
									sleep(2)
						while mihp==True and enehp==True:
							...
							while True:# no hay 'repetir' en python
								...
								if opcionataque==0:
									...
									print("ATAQUES Pok�mon")
									print("1.- ",enenombreataque[0]," | Tipo : ",enetipoa[0]," | pp : ",enepp[0],"  da�o: ",enedano[0])
									print("2.- ",enenombreataque[1]," | Tipo : ",enetipoa[1]," | pp : ",enepp[1],"  da�o: ",enedano[1])
									print("3.- ",enenombreataque[2]," | Tipo : ",enetipoa[2]," | pp : ",enepp[2],"  da�o: ",enedano[2])
									print("4.- ",enenombreataque[3]," | Tipo : ",enetipoa[3]," | pp : ",enepp[3],"  da�o: ",enedano[3])
									print("")
									print("",jugador1)
									print("Nombre Pok�mon:",minombrepoke," Nivel ",milvl)
									print("         Tipo pokemon: ",mitipo[0],"/",mitipo[1],"      Ps: ",misaludpoke)
									print("                          Defensa: ",midefensapoke,"  Velocidad: ",mivelocidadpoke)
									print("ATAQUES Pok�mon")
									print("1.- ",minombreataque[0]," | Tipo : ",mitipoa[0]," | pp : ",mipp[0],"  da�o: ",midano[0])
									print("2.- ",minombreataque[1]," | Tipo : ",mitipoa[1]," | pp : ",mipp[1],"  da�o: ",midano[1])
									print("3.- ",minombreataque[2]," | Tipo : ",mitipoa[2]," | pp : ",mipp[2],"  da�o: ",midano[2])
									print("4.- ",minombreataque[3]," | Tipo : ",mitipoa[3]," | pp : ",mipp[3],"  da�o: ",midano[3])
									input() # a diferencia del pseudoc�digo, espera un Enter, no cualquier tecla
							...
							if tipoe=="FUEGO" and miataque!="Giro Fuego" and (enetipo[0]!="FUEGO" or enetipo[1]!="FUEGO"):
								if (miataque=="Ascuas" or miataque=="Lanza Llamas" or miataque=="Pu�o Fuego") and suerte<=30:
									estadoa = "Quemado"
								...
								if enetipo[0]!="TIERRA" or enetipo[1]!="TIERRA":
									if miataque=="Onda Trueno":
										...
										if suerte<=20:
											estadoa = "Paralizado"
									suerte = randint(0,100)
									if suerte<=20 and miataque=="Pu�o Trueno":
										estadoa = "Paralizado"
							...
							# CONGELAR
							if tipoe=="HIELO":
								if (miataque=="Rayo Hielo" or miataque=="Vendisca" or miataque=="Pu�o Hielo") and suerte<=29 and (enetipo[0]!="HIELO" or enetipo[1]!="HIELO"):
									estadoa = "Congelado"
							if tipoe=="VENENO":
							...
							if tipox=="FUEGO" and eneataque!="Giro Fuego" and (mitipo[0]!="FUEGO" or mitipo[1]!="FUEGO"):
								if (eneataque=="Ascuas" or eneataque=="Lanza Llamas" or eneataque=="Pu�o Fuego") and suerte<=30:
									estadoe = "Quemado"
							# Disparo demoras baja un nivel de velocidad del pokemon enemigo, osea le resta "1".
								...
								if mitipo[0]!="TIERRA" or mitipo[1]!="TIERRA":
									if eneataque=="Onda Trueno":
										...
										if suerte<=20:
											estadoe = "Paralizado"
									suerte = randint(0,100)
									if suerte<=20 and eneataque=="Pu�o Trueno":
										estadoe = "Paralizado"
							...
							# CONGELAR
							if tipox=="HIELO":
								if (eneataque=="Rayo Hielo" or eneataque=="Vendisca" or eneataque=="Pu�o Hielo") and suerte<=29 and (mitipo[0]!="HIELO" or mitipo[1]!="HIELO"):
									estadoe = "Congelado"
							if tipox=="VENENO":
							...
							if paralizadoa==False and paralizadoe==False:
								if miv>=enev:
									...
									print("�",minombrepoke," us� ",miataque,"!")
									sleep(2)
									if miest!="":
										print("�mi Pok�mon ",minombrepoke," ",miest,"!")
										sleep(2)
									if estadofe!="":
										print("�El Pok�mon ",enenombrepoke," ",estadofe,"!")
										sleep(2)
									if enesaludpoke<=0:
										# Batalla termino
									...
									if enesaludpoke>0:
										...
										print("�Enemigo ",enenombrepoke," us� ",eneataque,"!")
										sleep(2)
										if eneest!="":
											print("�Enemigo Pok�mon ",enenombrepoke," ",eneest,"!")
											sleep(2)
										if estadofa!="":
											print("�mi Pok�mon ",minombrepoke," ",estadofa,"!")
											sleep(2)
										if misaludpoke<=0:
							...
							if misaludpoke==0 or enesaludpoke==0:
								if enesaludpoke==0:
									...
									print("      /_\\____/_\\             |-----------------")
									print("�------------------------------------------------�")
									print("|  �Pok�mon ",enenombrepoke," debilitado!")
									sleep(1)
								...
								if misaludpoke==0:
									...
									print("     /_\\  !   /_\\            |-----------------")
									print("�------------------------------------------------�")
									print("|  �Tu Pok�mon ",minombrepoke," se ha debilitado!")
									sleep(1)
			...
			if opc3==3:
				...
				if opc5==2:
					if cantidadpoke==1:
						print("")
						print("�Reiniciando PP tu Pok�mon ",jugador1,"!")
						sleep(2)
						print("")
						print("�Reiniciando PP de los Pok�mon ",enemigo1,"!")
						sleep(2)
						for contx in range(4):
					...
					if cantidadpoke==6:
						print("")
						print("�Reiniciando PP de tus Pok�mon ",jugador1,"!")
						sleep(2)
						print("")
						print("�Reiniciando PP de los Pok�mon ",enemigo1,"!")
						sleep(2)
				...
				if opc5==1:
					...
					print("@-----------------------------------------------------------------------------------------------------------@")
					print("| N�MERO |  NOMBRE     |  TIPO 1  | TIPO 2  | SALUD   |  ATAQUE  | DEFENSA | VELOCIDAD | ESPECIAL | TOTAL   |")
					print("|-----------------------------------------------------------------------------------------------------------|")
					...
					print("|-----------------------------------------------------------------------------------------------------------|")
					print("PRESIONES CUALQUIER TECLA PARA CONTINUAR                                                             P�g 1/8")
					input() # a diferencia del pseudoc�digo, espera un Enter, no cualquier tecla
					print("") # no hay forma directa de borrar la pantalla con Python estandar
					print("@-----------------------------------------------------------------------------------------------------------@")
					print("| N�MERO |  NOMBRE     |  TIPO 1  | TIPO 2  | SALUD   |  ATAQUE  | DEFENSA | VELOCIDAD | ESPECIAL | TOTAL   |")
					...
					print("|-----------------------------------------------------------------------------------------------------------|")
					print("PRESIONES CUALQUIER TECLA PARA CONTINUAR                                                             P�g 2/8")
					input() # a diferencia del pseudoc�digo, espera un Enter, no cualquier tecla
					print("") # no hay forma directa de borrar la pantalla con Python estandar
					print("@-----------------------------------------------------------------------------------------------------------@")
					print("| N�MERO |  NOMBRE     |  TIPO 1  | TIPO 2  | SALUD   |  ATAQUE  | DEFENSA | VELOCIDAD | ESPECIAL | TOTAL   |")
					...
					print("|-----------------------------------------------------------------------------------------------------------|")
					print("PRESIONES CUALQUIER TECLA PARA CONTINUAR                                                             P�g 3/8")
					input() # a diferencia del pseudoc�digo, espera un Enter, no cualquier tecla
					print("") # no hay forma directa de borrar la pantalla con Python estandar
					print("@-----------------------------------------------------------------------------------------------------------@")
					print("| N�MERO |  NOMBRE     |  TIPO 1  | TIPO 2  | SALUD   |  ATAQUE  | DEFENSA | VELOCIDAD | ESPECIAL | TOTAL   |")
					...
					print("|-----------------------------------------------------------------------------------------------------------|")
					print("PRESIONES CUALQUIER TECLA PARA CONTINUAR                                                             P�g 4/8")
					input() # a diferencia del pseudoc�digo, espera un Enter, no cualquier tecla
					print("") # no hay forma directa de borrar la pantalla con Python estandar
					print("@-----------------------------------------------------------------------------------------------------------@")
					print("| N�MERO |  NOMBRE     |  TIPO 1  | TIPO 2  | SALUD   |  ATAQUE  | DEFENSA | VELOCIDAD | ESPECIAL | TOTAL   |")
					...
					print("|-----------------------------------------------------------------------------------------------------------|")
					print("PRESIONES CUALQUIER TECLA PARA CONTINUAR                                                             P�g 5/8")
					input() # a diferencia del pseudoc�digo, espera un Enter, no cualquier tecla
					print("") # no hay forma directa de borrar la pantalla con Python estandar
					print("@-----------------------------------------------------------------------------------------------------------@")
					print("| N�MERO |  NOMBRE     |  TIPO 1  | TIPO 2  | SALUD   |  ATAQUE  | DEFENSA | VELOCIDAD | ESPECIAL | TOTAL   |")
					...
					print("|-----------------------------------------------------------------------------------------------------------|")
					print("PRESIONES CUALQUIER TECLA PARA CONTINUAR                                                             P�g 6/8")
					input() # a diferencia del pseudoc�digo, espera un Enter, no cualquier tecla
					print("") # no hay forma directa de borrar la pantalla con Python estandar
					print("@-----------------------------------------------------------------------------------------------------------@")
					print("| N�MERO |  NOMBRE     |  TIPO 1  | TIPO 2  | SALUD   |  ATAQUE  | DEFENSA | VELOCIDAD | ESPECIAL | TOTAL   |")
					...
					print("|-----------------------------------------------------------------------------------------------------------|")
					print("PRESIONES CUALQUIER TECLA PARA CONTINUAR                                                             P�g 7/8")
					input() # a diferencia del pseudoc�digo, espera un Enter, no cualquier tecla
					print("") # no hay forma directa de borrar la pantalla con Python estandar
					print("@-----------------------------------------------------------------------------------------------------------@")
					print("| N�MERO |  NOMBRE     |  TIPO 1  | TIPO 2  | SALUD   |  ATAQUE  | DEFENSA | VELOCIDAD | ESPECIAL | TOTAL   |")
					...
					print("@-----------------------------------------------------------------------------------------------------------@")
					print("PRESIONES CUALQUIER TECLA PARA CONTINUAR                                                             P�g 8/8")
					input() # a diferencia del pseudoc�digo, espera un Enter, no cualquier tecla
					err = 0
					for z in range(2,7):
